...
#define TOKEN "BBFF-dzMITnzBRyo8lhLBE46N80nOlD840Y" // Ubidots TOKEN name el mismo que usamos en clase
#define MQTT_CLIENT_NAME "BBFF-0964360e9b48ea1cbc6700b2a9294787f11" //ID del cliente, 8 a 12 chars alfanumericos (ASCII), debe ser random y unico dif a otros devices
