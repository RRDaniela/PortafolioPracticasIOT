...
#define TOKEN "BBFF-JuyXjdbrqIWSCA3b0oFWPg0UqWMxwd" // Put your Ubidots' TOKEN
#define MQTT_CLIENT_NAME "BBFF-JuyXjdbrqIWSCA3b0oFWPg0UqWMxwd" // MQTT client Name, please enter your own 8-12 alphanumeric character ASCII string; 
